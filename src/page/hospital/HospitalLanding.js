  ...
  return (
    <div>
        ...
        <figure class="banner-icon mb-0">
            <img src="./assets/images/choose-logoimage.png" alt="image" class="img-fluid"/>
        </figure>
        <div class="container">
            <div class="row aos-init" data-aos="fade-up">
                <div class="col-lg-10 col-12 mx-auto">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style={{transform: "translate3d(-1900px, 0px, 0px)", transition: "0.25s", width: "6650px"}}><div class="owl-item cloned" style={{width: "920px", marginRight: "30px"}}><div class="item">
                        ...
                        <div class="owl-nav"
                        ><button type="button" role="presentation" class="owl-prev"><span aria-label="Previous" ></span></button><button type="button" role="presentation" class="owl-next"><span aria-label="Next" ></span></button></div><div class="owl-dots disabled"></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <figure class="service-rightimage mb-0">
        <img src="./assets/images/about-rightimage.png" alt="image" class="img-fluid"/>
    </figure>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-1 order-2">
                <div class="service_contentbox aos-init aos-animate" data-aos="fade-up">
                    <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-2 order-1">
                <div class="service_content aos-init aos-animate" data-aos="fade-up">
                    <h6>What We Offer</h6>
                    ...
                    <a href="./service.html" class="text-decoration-none primary_btn">View All<i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>

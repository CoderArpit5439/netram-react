        ...
        <div class="container">
          <div class="row">
            <div class="col-12 mx-auto">
              <div
                class="service_content text-center aos-init aos-animate"
                data-aos="fade-up"
              >
                <h6>Indore optical</h6>
                <h2>Shree netram optical</h2>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12 column">
              <div
                class="box1 aos-init aos-animate"
                data-aos="fade-up"
                data-aos-duration="700"
              >
                <h4>Search News</h4>
                  ...
                  <div class="form-row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <input
                        ...
                        name="search"
                        id="searchblog"
                        class="form-control upper_layer"

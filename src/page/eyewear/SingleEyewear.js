        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="main-box">
                        <figure class="image1 mb-3 aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
                            <img src="./assets/images/singleblog-image1.jpg" alt="image" class="img-fluid" loading="lazy"/>
                        </figure>
                        <div class="content1 aos-init" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="content2 aos-init" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="content3 aos-init" data-aos="fade-up" data-aos-duration="700">
                            <figure class="image1 mb-3 aos-init" data-aos="fade-up">
                        ...
                        <div class="content4 aos-init" data-aos="fade-up" data-aos-duration="700">
                            <div class="row">
                        ...
                        <div class="buttons aos-init" data-aos="fade-up">
                        ...
                        <div class="content5 aos-init" data-aos="fade-up" data-aos-duration="700">
                            <figure class="singleblog-review1 mb-0">
                                <img src="./assets/images/singleblog-review1.jpg" alt="image" class="img-fluid" loading="lazy"/>
                            </figure>
                            <div class="content">
                                <h4>Billy wallson</h4>
                        ...
                        <div class="content6 aos-init" data-aos="fade-up" data-aos-duration="700">
                            <h4>2 Comments</h4>
                            <div class="comment">
                                <div class="image aos-init" data-aos="flip-left"><img alt="image" src="assets/images/singleblog-review2.jpg" class="avatar" loading="lazy"/></div>
                                <div class="content">
                            ...
                            <div class="comment">
                                <div class="image aos-init" data-aos="flip-left"><img alt="image" src="assets/images/singleblog-review3.jpg" class="avatar" loading="lazy"/></div>
                                <div class="content">
                        ...
                        <div class="content7 aos-init" data-aos="fade-up" data-aos-duration="700">
                            <h4>Leave a Comment</h4>
                            <form id="blogpage" method="POST">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-0">
                                            <textarea class="form_style" placeholder="Enter your comment here..." rows="3" name="msg"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-0">
                                            <input type="text" class="form_style text-mb" placeholder="Your topic" name="topic"/>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 column">
                    <div class="box1 aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
                        <h4>Search News</h4>
                        <form method="POST">
                            <div class="form-row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" name="search" id="searchblog" class="form-control upper_layer" placeholder="Search Here..."/>
                    ...
                    <div class="box1 box2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <div class="box1 box3 aos-init" data-aos="fade-up" data-aos-duration="700">
                        <h4>Follow Us</h4>
                        <div class="social-icons">
                            <ul class="mb-0 list-unstyled ">
                                ...
                                <li><a href="https://twitter.com/" class="text-decoration-none"><i class="fa-brands fa-x-twitter social-networks"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="box1 box4 aos-init" data-aos="fade-up" data-aos-duration="700">
                        <h4>Tags</h4>
                    ...
                    <div class="box1 box5 aos-init" data-aos="fade-up" data-aos-duration="700">
                        <h4>Feeds</h4>
                        <div class="feed">
                            <figure class="feed-image mb-0">
                                <img src="./assets/images/singleblog-feed1.jpg" alt="image" class="img-fluid" loading="lazy"/>
                            </figure>
                        ...
                        <div class="feed">
                            <figure class="feed-image mb-0">
                                <img src="./assets/images/singleblog-feed2.jpg" alt="image" class="img-fluid" loading="lazy"/>
                            </figure>
                            <a href="six-colum-full-wide.html" class="mb-0">Why You Need Virtual Assistant for Your
                                Company</a>
                        </div>
                        <div class="feed">
                            <figure class="feed-image mb-0">
                                <img src="./assets/images/singleblog-feed3.jpg" alt="image" class="img-fluid" loading="lazy"/>
                            </figure>
                            <a href="six-colum-full-wide.html" class="mb-0">Why You Need Virtual Assistant for Your
                                Company</a>
                        </div>
                        <div class="feed feed4">
                            <figure class="feed-image mb-0">
                                <img src="./assets/images/singleblog-feed4.jpg" alt="image" class="img-fluid" loading="lazy"/>
                            </figure>
                            <a href="six-colum-full-wide.html" class="mb-0">Why You Need Virtual Assistant for Your
                                Company</a>
                        </div>

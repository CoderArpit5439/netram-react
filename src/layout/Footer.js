              ...
              <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                <div class="logo-content">
                  <a href="index.html" class="footer-logo">
                    <figure class="mb-0">
                      <img src="assets/images/sno-logo.png" alt="image" />
                    </figure>
                  </a>
                  <p class="text text-size-14">
                    E-Netram is your trusted destination for advanced eye care and stylish eyewear, combining precision, passion, and 02+ years of expertise in vision wellness.
                  </p>
                ...
                <div class="contact">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="text">
                      ...
                      <a
                        href="https://www.google.com/maps/course/21+King+St,+Melbourne+VIC+3000,+Australia/@-37.8199805,144.9529083,18z/data=!4m6!3m5!1s0x6ad65d52754eaecb:0x22f367daf52cbd47!8m2!3d-37.819936!4d144.9570765!16s%2Fg%2F11c2dj2n2c?entry=ttu"
                        class="text-decoration-none address mb-0"
                      >
        ...
        {/* <div id="fixed-form-container">
          <div class="image">
            <figure class="footer-contactimage mb-0">
              <img
                src="assets/images/footer-contactimage.png"
                alt="image"
                class="img-fluid"
              />
            </figure>
